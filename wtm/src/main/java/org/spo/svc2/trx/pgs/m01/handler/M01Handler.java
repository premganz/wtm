...
import org.spo.svc2.trx.pgs.m01.task.M0103;
...
public class M01Handler extends AbstractHandler{
  ...
  public static final NavEvent EV_SWITCH_TO_SUB_LAND =  NavEvent.create(EventType.TASKSET, "03");
  
   @Override
   public void configureChannel() {
			taskChannel.put("01",m0101);
			taskChannel.put("02",m0102);
			taskChannel.put("03",m0103);
   }
